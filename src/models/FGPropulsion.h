...
public:
    ...
    inline unsigned int GetNumEngines(void) const
    {
        return (unsigned int)Engines.size();
    }
    ...
    inline unsigned int GetNumTanks(void) const
    {
        return (unsigned int)Tanks.size();
    }
    ...
    inline int GetnumSelectedFuelTanks(void) const
    {
        return numSelectedFuelTanks;
    }

    /** Returns the number of oxidizer tanks currently actively supplying oxidizer */
    inline int GetnumSelectedOxiTanks(void) const
    {
        return numSelectedOxiTanks;
    }
    ...
    inline double GetForces(int n) const
    {
        return vForces(n);
    }
    ...
    inline double GetMoments(int n) const
    {
        return vMoments(n);
    }

    inline bool GetRefuel(void) const
    {
        return refuel;
    }
    inline void SetRefuel(bool setting)
    {
        refuel = setting;
    }
    inline bool GetFuelDump(void) const
    {
        return dump;
    }
    inline void SetFuelDump(bool setting)
    {
        dump = setting;
    }
    ...
    inline bool GetFuelFreeze(void)
    {
        return fuel_freeze;
    }
