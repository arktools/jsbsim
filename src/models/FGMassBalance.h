...
public:
    ...
    inline void SetEmptyWeight(double EW)
    {
        EmptyWeight = EW;
    }
    inline void SetBaseCG(const FGColumnVector3& CG)
    {
...
private:
    ...
    struct PointMass
    {
        ...
        double GetPointMassLocation(int axis) const
        {
            return Location(axis);
        }
        double GetPointMassWeight(void) const
        {
            return Weight;
        }
        esShape GetShapeType(void)
        {
            return eShapeType;
        }
        ...
        FGMatrix33 GetPointMassInertia(void)
        {
            return mPMInertia;
        }
        string GetName(void)
        ...
        void SetPointMassLocation(int axis, double value)
        {
            Location(axis) = value;
        }
        ...
        void SetPointMassShapeType(esShape st)
        {
            eShapeType = st;
        }
        ...
        double GetPointMassMoI(int r, int c)
        {
