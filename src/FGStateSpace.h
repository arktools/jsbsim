...
public:
	...
	public: 
		...
		virtual double getDeriv() const { return 0; }; 
	...
	public:
		...
		double get() const { return m_fdm->GetAuxiliary()->GetVt(); }
	...
	public:
		...
		double get() const { return m_fdm->GetAuxiliary()->Getalpha(); }
		void set(double val) { m_fdm->GetAuxiliary()->Setalpha(val); }
		double getDeriv() const { return m_fdm->GetAuxiliary()->Getadot(); }
	};
	class Theta : public Component
	{
	public:
		Theta() : Component("Theta","rad") {};
		double get() const { return m_fdm->GetPropagate()->GetEuler(1); }
		void set(double val) {
		...
		double getDeriv() const { return m_fdm->GetAuxiliary()->GetEulerRates(1); }
	};
	class Q : public Component
	{
	public:
		Q() : Component("Q","rad/s") {};
		double get() const { return m_fdm->GetPropagate()->GetPQR(2); }
		void set(double val) { m_fdm->GetPropagate()->SetPQR(2,val); }
		double getDeriv() const { return m_fdm->GetPropagate()->GetPQRdot(2); }
	};
	class Alt : public Component
	{
	public:
		Alt() : Component("Alt","ft") {};
		double get() const { return m_fdm->GetPropagate()->GetAltitudeASL(); }
		void set(double val) { m_fdm->GetPropagate()->SetAltitudeASL(val); }
		double getDeriv() const { return m_fdm->GetPropagate()->Gethdot(); }
	};
	...
	public:
		P() : Component("P","rad/s") {};
		double get() const { return m_fdm->GetPropagate()->GetPQR(1); }
		void set(double val) { m_fdm->GetPropagate()->SetPQR(1,val); }
		double getDeriv() const { return m_fdm->GetPropagate()->GetPQRdot(1); }
	};
	class R : public Component
	{
	public:
		R() : Component("R","rad/s") {};
		double get() const { return m_fdm->GetPropagate()->GetPQR(3); }
		void set(double val) { m_fdm->GetPropagate()->SetPQR(3,val); }
		double getDeriv() const { return m_fdm->GetPropagate()->GetPQRdot(3); }
	};
	class Psi : public Component
	{
	public:
		Psi() : Component("Psi","rad") {};
		double get() const { return m_fdm->GetPropagate()->GetEuler(3); }
		void set(double val) {
			double phi = m_fdm->GetPropagate()->GetEuler(1);
			double theta = m_fdm->GetPropagate()->GetEuler(2);
	...
	public:
		...
		double get() const { return m_fdm->GetFCS()->GetDaCmd(); }
	...
	public:
		...
		double get() const { return m_fdm->GetFCS()->GetDaLPos(); }
		void set(double val)
		{
	...
	public:
		...
		double get() const { return m_fdm->GetFCS()->GetDeCmd(); }
	...
	public:
		...
		double get() const { return m_fdm->GetFCS()->GetDePos(); }
	...
	public:
		...
		double get() const { return m_fdm->GetFCS()->GetDrCmd(); }
	...
	public:
		...
		double get() const { return m_fdm->GetFCS()->GetDrPos(); }
	...
	public:
		...
		double get() const { return m_fdm->GetPropulsion()->GetEngine(0)->GetThruster()->GetRPM(); }
		void set(double val)
		{ 
			for (int i=0;i<m_fdm->GetPropulsion()->GetNumEngines();i++)
	...
	public:
		...
		double get() const { return m_fdm->GetPropulsion()->GetEngine(0)->GetThruster()->GetPitch(); }
		void set(double val)
		{ 
			for (int i=0;i<m_fdm->GetPropulsion()->GetNumEngines();i++)
	...
	public:
		...
		Component * getComp(int i) { return m_v[i]; };
		double get(int i) const { return m_v[i]->get(); };
		void set(int i, double val) const { return m_v[i]->set(val); };
		double get(int i) { return m_v[i]->get(); };
		...
		std::string getName(int i) const { return m_v[i]->getName(); };
		...
		std::string getUnit(int i) const { return m_v[i]->getUnit(); };
