...
string Aeromatic::PrintEngine()
{
    ...
    {
    case etPiston:
        f << "    power:          " << enginePower << " hp\n";
        break;
    case etTurbine:
        f << "    thrust:         " << engineThrust << " lb\n";
        break;
    case etTurboprop:
        f << "    power:          " << enginePower << " hp\n";
        break;
...
string Aeromatic::PrintAero()
{
    ...
    if (htailarea == 0.0)
    {
        ...
        {
        case atGlider:
            htailarea = wingarea * 0.12;
            break;
        case atLtSingle:
            htailarea = wingarea * 0.16;
            break;
        case atLtTwin:
            htailarea = wingarea * 0.16;
            break;
        case atRacer:
            htailarea = wingarea * 0.17;
            break;
        case atSEFighter:
            htailarea = wingarea * 0.20;
            break;
        case at2EFighter:
            htailarea = wingarea * 0.20;
            break;
        case at2ETransport:
            htailarea = wingarea * 0.25;
            break;
        case at3ETransport:
            htailarea = wingarea * 0.25;
            break;
    ...
    if (htailarm == 0.0)
    {
        ...
        {
        case atGlider:
            htailarm = length * 0.60;
            break;
        case atLtSingle:
            htailarm = length * 0.52;
            break;
        case atLtTwin:
            htailarm = length * 0.50;
            break;
        case atRacer:
            htailarm = length * 0.60;
            break;
        case atSEFighter:
            htailarm = length * 0.40;
            break;
        case at2EFighter:
            htailarm = length * 0.40;
            break;
        case at2ETransport:
            htailarm = length * 0.45;
            break;
        case at3ETransport:
            htailarm = length * 0.45;
            break;
    ...
    if (vtailarea == 0.0)
    {
        ...
        {
        case atGlider:
            vtailarea = wingarea * 0.10;
            break;
        case atLtSingle:
            vtailarea = wingarea * 0.10;
            break;
        case atLtTwin:
            vtailarea = wingarea * 0.18;
            break;
        case atRacer:
            vtailarea = wingarea * 0.10;
            break;
        case atSEFighter:
            vtailarea = wingarea * 0.12;
            break;
        case at2EFighter:
            vtailarea = wingarea * 0.18;
            break;
        case at2ETransport:
            vtailarea = wingarea * 0.20;
            break;
        case at3ETransport:
            vtailarea = wingarea * 0.20;
            break;
    ...
    if (vtailarm == 0.0)
    {
        ...
        {
        case atGlider:
            vtailarm = length * 0.60;
            break;
        case atLtSingle:
            vtailarm = length * 0.50;
            break;
        case atLtTwin:
            vtailarm = length * 0.50;
            break;
        case atRacer:
            ...
            break;
        case atSEFighter:
            vtailarm = length * 0.40;
            break;
        case at2EFighter:
            vtailarm = length * 0.40;
            break;
        case at2ETransport:
            vtailarm = length * 0.45;
            break;
        case at3ETransport:
            vtailarm = length * 0.45;
            break;
...
// use Roskam's formulae to estimate moments of inertia
    ...
    {
    case atGlider:
        gearlocy_main = wingspan * 0.005* 12;
        break;
    case atLtSingle:
        gearlocy_main = wingspan * 0.09 * 12;
        break;
    case atLtTwin:
        gearlocy_main = wingspan * 0.09 * 12;
        break;
    case atRacer:
        gearlocy_main = wingspan * 0.15 * 12;
        break;
    case atSEFighter:
        gearlocy_main = wingspan * 0.09 * 12;
        break;
    ...
    case at4ETransport:
        ...
        break;
    case atMEProp:
        gearlocy_main = wingspan * 0.11 * 12;
        break;
    }
    ...
    case at2EFighter:
        ...
        break;
    case at2ETransport:
        tankcapacity = MTOW/23.0/(engines + 1);
        break;
    case at3ETransport:
        tankcapacity = MTOW/16.0/(engines + 1);
        break;
    case at4ETransport:
        tankcapacity = MTOW/16.0/(engines + 1);
        break;
    case atMEProp:
        tankcapacity = MTOW/18.0/(engines + 1);
        break;
    }
...
//************************************************
    ...
    case atLtTwin:
        ...
        break;
    case atRacer:
        f << "    type:          WWII fighter, subsonic sport, aerobatic\n";
        break;
    case atSEFighter:
        f << "    type:          single-engine transonic/supersonic fighter\n";
        break;
    case at2EFighter:
        f << "    type:          two-engine transonic/supersonic fighter\n";
        break;
    case at2ETransport:
        f << "    type:          two-engine transonic transport\n";
        break;
    case at3ETransport:
        f << "    type:          three-engine transonic transport\n";
        break;
    case at4ETransport:
        f << "    type:          four-engine transonic transport\n";
        break;
    case atMEProp:
        f << "    type:          multi-engine prop transport\n";
        break;
    }
    ...
    {
    case etPiston:
        f << "    engine type:   piston\n";
        break;
    case etTurbine:
        f << "    engine type:   turbine\n";
        break;
    case etTurboprop:
        f << "    engine type:   turboprop\n";
        break;
    case etRocket:
        f << "    engine type:   rocket\n";
        break;
    }
    ...
    {
    case elFwd_Fuselage:
        f << "    engine layout: forward fuselage\n";
        break;
    case elMid_Fuselage:
        f << "    engine layout: middle fuselage\n";
        break;
    case elAft_Fuselage:
        f << "    engine layout: aft fuselage\n";
        break;
    case elWings:
        f << "    engine layout: wings\n";
        break;
    case elWings_Tail:
        f << "    engine layout: wings and tail\n";
        break;
    case elWings_Nose:
        f << "    engine layout: wings and nose\n";
        break;
    }
