...
public:
    ...
    void SetAircraftName(string n)
    {
        AircraftName=n;
    }
    void SetEngineName(string n)
    {
        EngineName=n;
    }
    void SetPropName(string n)
    {
        PropName=n;
    }
    void SetAircraftType(aircraftType t)
    {
        aType=t;
    }
    ...
    void SetTricycle(bool t)
    {
        tricycle=t;
    }
    void SetRetractable(bool r)
    {
        retractable=r;
    }
    ...
    void SetEngineLayout(engineLayoutType el)
    {
        elType=el;
    }
    void SetYawDamper(bool d)
    {
        yawdamper=d;
    }
    ...
    void SetPropDiameter(double d)
    {
        diameter=d;
    }
    void SetEngineThrust(double t)
    {
        engineThrust=t;
    }
    void SetAugmented(bool a)
    {
        augmentation=a;
    }
    void SetInjected(bool i)
    {
        injection=i;
    }
