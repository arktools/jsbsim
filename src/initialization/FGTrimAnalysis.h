...
public:
    ...
    */
    ...
    {
        if (rf.is_open()) return &rf;    // const_cast<ofstream*>(&rf) (if rf is not mutable)
        else return 0;
    }
    ...
    */
    inline void SetCostFunctionValue(double value)
    {
    ...
    */
    inline double GetCostFunctionValue() const
    {
    ...
    */
    ...
    /** @return The Trim Analysis mode
               taLongitudinal, taFull, taGround, taCustom, or taNone
    */
    inline TrimAnalysisMode GetMode() const
    {
        return mode;
    };

    inline vector<FGTrimAnalysisControl*>* GetControls()
    {
    ...
    */
    ...
    /** Sets trim result status
        @param tf (boolean)
    */
    inline void SetTrimFailed(bool tf)
    {
        trim_failed = tf;
    }
    ...
    */
    inline bool GetTrimFailed(void)
    {
        return trim_failed;
    }
    inline void SetTrimSuccessfull()
    {
        trim_failed = false;
    }
