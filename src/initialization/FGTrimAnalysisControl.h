...
public:
    ...
    */
    ...
    /** Return the control type
        @return TaControl
    */
    inline TaControl GetControlType(void)
    {
        return control;
    }
    ...
    */
    inline void SetControlStep(double value)
    {
        control_step = value;
    }
    /** Get control step
    ...
    */
    inline double GetControlStep(void)
    {
        return control_step;
    }
    ...
    */
    inline void SetControlInitialValue(double value)
    {
    ...
    */
    inline double GetControlInitialValue(void)
    {
